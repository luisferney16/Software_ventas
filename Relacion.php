...
<br><br>
<div class="container">
    <h3>RELACIÓN VENTAS Y GASTOS</h3>
    ...
    $("#generarReporte").click(function(){   
        ...
        $.ajax({
          ...
          success: function(data){
             ...
             console.log(objeto[0].totalV);
             var totalNeto = parseInt(objeto[0].totalV) - parseInt(objeto[0].totalG);
             var i = 1;
             for(var i=0; i< objeto.length; ++i){
              var fila = '<tr id="row' + i + '"><td>' + objeto[i].totalV + '</td><td>' + objeto[i].totalG + '</td><td>' + totalNeto + '</td></tr>'; //esto seria lo que contendria la fila
              $('#mytable tr:first').after(fila);
              
              //console.log(objeto[0].Id);
             }
            document.getElementById("total").value = totalNeto;
         console.log(totalV);
